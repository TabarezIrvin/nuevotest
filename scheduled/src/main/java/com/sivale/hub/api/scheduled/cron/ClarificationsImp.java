...
import com.sivale.hub.api.scheduled.constants.fields.mandatorys.FieldsDefaultClarifications;
 ...
 */
@ISchedulerJob
public class ClarificationsImp {

    static final Logger log = LoggerFactory.getLogger(ClarificationsImp.class);
    ...
    @Value("${sivale.ruta.origen.aclaraciones.win}")
    private String windowsOrigin;

    @Value("${sivale.ruta.destino.aclaraciones.win}")
    private String windowsDestination;
    
    @Value("${sivale.ruta.origen.aclaraciones.linux}")
    private String linuxOrigin;

    @Value("${sivale.ruta.destino.aclaraciones.linux}")
    private String linuxDestination;
    
    @Value("${sivale.nombre.tabla.aclaraciones}")
    ...
    private String cronJobName = "cronJobClarifications";
    private String pathC = null;
    private String pathPython = null;
    
    @Scheduled(cron = "${cronExpression}")
    public void cronJobClarifications() {
	...
	FieldsDefaultClarifications fieldsDefaultAclaraciones = new FieldsDefaultClarifications();
	...
	if (existingFiles != null) {
		...
		operationPerformed |= cef.processExcel(destination, existingFiles[i], this.shapeFields(fieldsDefaultAclaraciones),
			paths, factor);
	    }
	}
	...
	if (operationPerformed) {
	    ...
	    operationPerformed |= postgres.insertFile(this.dataForm(), fieldsDefaultAclaraciones.positionFieldBD(),
    ...
    private List<HashMap> shapeFields(FieldsDefaultClarifications fieldsDefaultAclaraciones) {
	List<HashMap> fields = new ArrayList<>();
	fields.add(fieldsDefaultAclaraciones.fieldTypeExcel());
	fields.add(fieldsDefaultAclaraciones.mappingDBExcel());
	fields.add(fieldsDefaultAclaraciones.positionFieldBD());
	return fields;
    }
