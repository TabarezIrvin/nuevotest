 ...
 */
public class KeyMonitorCVVImp {

    static final Logger log = LoggerFactory.getLogger(KeyMonitorCVVImp.class);
    ...
    @Value("${sivale.ruta.origen.keymonitorcvv.win}")
    private String windowsOrigin;

    @Value("${sivale.ruta.destino.keymonitorcvv.win}")
    private String windowsDestination;
    
    @Value("${sivale.ruta.origen.keymonitorcvv.linux}")
    private String linuxOrigin;

    @Value("${sivale.ruta.destino.keymonitorcvv.linux}")
    private String linuxDestination;
    
    @Value("${sivale.nombre.tabla.keymonitorcvv}")
    ...
    private String cronJobName = "cronJobKeymonitorCVV";
    private String pathC = null;
    private String pathPython = null;
    
    @Scheduled(cron = "${cronExpression}")
    public void cronJobKeymonitorCVV() {
