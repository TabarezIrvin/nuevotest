...
import com.sivale.hub.api.scheduled.constants.fields.mandatorys.FieldsDefaultFalcon;
 ...
 */
@ISchedulerJob
public class FalconImp {
    
    static final Logger log = LoggerFactory.getLogger(FalconImp.class);
    ...
    @Value("${sivale.ruta.origen.falcon.win}")
    private String windowsOrigin;

    @Value("${sivale.ruta.destino.falcon.win}")
    private String windowsDestination;
    
    @Value("${sivale.ruta.origen.falcon.linux}")
    private String linuxOrigin;

    @Value("${sivale.ruta.destino.falcon.linux}")
    private String linuxDestination;
    
    @Value("${sivale.nombre.tabla.falcon}")
    ...
    private String cronJobName = "cronJobFalcon";
    private String pathC = null;
    private String pathPython = null;
    
    @Scheduled(cron = "${cronExpression}")
    public void cronJobFalcon() {
	...
	FieldsDefaultFalcon fieldsDefaultFalcon = new FieldsDefaultFalcon();
	...
	if (existingFiles != null) {
		...
		operationPerformed |= cef.processExcel(destination, existingFiles[i], this.shapeFields(fieldsDefaultFalcon),
			paths, factor);
	    }
	}
	...
	if (operationPerformed) {
	    ...
	    operationPerformed |= postgres.insertFile(this.dataForm(), fieldsDefaultFalcon.positionFieldBD(),
     ...
     * @param fieldsDefaultFalcon
     * @return
     */
    @SuppressWarnings("rawtypes")
    private List<HashMap> shapeFields(FieldsDefaultFalcon fieldsDefaultFalcon) {
	List<HashMap> fields = new ArrayList<>();
	fields.add(fieldsDefaultFalcon.fieldTypeExcel());
	fields.add(fieldsDefaultFalcon.mappingDBExcel());
	fields.add(fieldsDefaultFalcon.positionFieldBD());
	return fields;
    }
