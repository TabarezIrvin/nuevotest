 ...
 */
@ISchedulerJob
public class KeyMonitorImp {

    static final Logger log = LoggerFactory.getLogger(KeyMonitorImp.class);
    ...
    @Value("${sivale.ruta.origen.keymonitor.win}")
    private String windowsOrigin;

    @Value("${sivale.ruta.destino.keymonitor.win}")
    private String windowsDestination;
    
    @Value("${sivale.ruta.origen.keymonitor.linux}")
    private String linuxOrigin;

    @Value("${sivale.ruta.destino.keymonitor.linux}")
    private String linuxDestination;
    
    @Value("${sivale.nombre.tabla.keymonitor}")
    ...
    private String cronJobName = "cronJobKeymonitor";
    private String pathC = null;
    private String pathPython = null;
    
    @Scheduled(cron = "${cronExpression}")
    public void cronJobKeymonitor() {
